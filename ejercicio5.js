...
Si no se te ocurre como hacer un numero aleatorio no te preocupes! busca información sobre la función de 
javascript Math.random(); */

function rollDice(value) {

    const randomNumber = Math.random();
    const result = Math.ceil(randomNumber * value);

    return result;
}

const tirada = rollDice(20);
console.log(tirada);